...
<a href="https://en.wikipedia.org/wiki/Sokoban" target="_blank">Sokoban</a> is a 80's game where the objetive is to put every boxes of the grid into the goal points to pass to the next level. In this version we change every game sprites to make it prittier and different.
